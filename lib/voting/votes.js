...
console.log(user, body, voteCast);
...
console.log(positive, negative, monkey);
    ...
    VoteController.prototype.isPositive = function isPositive (text) {
      return this.votePositive.some(function (monkey) {
    ...
    VoteController.prototype.isNegative = function isNegative (text) {
      return this.voteNegative.some(function (monkey) {
        return (text.indexOf(monkey) !== -1);
      });
    };
